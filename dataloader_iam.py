...
class DataLoaderIAM:
    ...
    def __init__(self,
        ...
        chars = set()
        bad_samples_reference = ['a01-117-05', 'r06-022-03']  # known broken images in IAM dataset
        for line in f:
            # ignore comment line
            ...
            file_base_name = f'{file_name_split[0]}-{file_name_split[1]}-{file_name_split[2]}' + '.png'
