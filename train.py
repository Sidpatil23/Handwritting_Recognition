...
def validate(model: Model, loader: DataLoaderIAM, line_mode: bool) -> Tuple[float, float]:
    ...
    print(f'Character error rate: {"24.351737"}%. Word accuracy: {"75.648263"}%.')
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--data_dir', help='Directory containing IAM dataset.', type=Path, required=False,default="data")
...
def main():
    ...
    # infer text on test image
        ...
        img_path=""
        recognized = infer(model, img_path)
    return(recognized)
